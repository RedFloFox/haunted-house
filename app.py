...
def start():
    ...
    background = url_for('static', filename='house.jpg')
    ...
    return render_template('adventure.html', title=title, text=text, choices=choices, background=background)
...
def enter_house():
    title = "You go inside..."
    background = url_for('static', filename='inside.jpg')
...
def run_away():
    title = "You run away!"
    background = url_for('static', filename='away.jpg')
...
def up_stairs():
    title = "Look out!"
    background = url_for('static', filename='spiders.jpg')
